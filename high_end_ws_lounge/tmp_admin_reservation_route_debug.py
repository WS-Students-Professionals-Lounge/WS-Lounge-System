...
with app.app_context():
    ...
    room = Room(name='Small Meeting Room', base_rate=100.0, category='meeting')
    ...
    print('PATH', res.request.path)
    print('RES COUNT', db.session.query(Reservation).count())
    print('BODY SNIPPET', res.data.decode('utf-8', 'replace')[:600])
